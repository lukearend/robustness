...
#SBATCH --job-name=imagenet-00002
#SBATCH --output=out/imagenet-00002.out
...
--model_dir=/om/user/larend/models/robust/imagenet/00002 \
--scale_factor=1 \
--dataset=imagenet \
--pickle_dir=/om/user/larend/pickles/imagenet/00002 \
--host_filesystem=/om
