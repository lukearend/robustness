...
#SBATCH --job-name=cifar10-00000
#SBATCH --output=out/cifar10-00000.out
...
--model_dir=/om/user/larend/models/robust/cifar10/00000 \
--scale_factor=0.25 \
--dataset=cifar10 \
--pickle_dir=/om/user/larend/pickles/cifar10/00000 \
--host_filesystem=/om
