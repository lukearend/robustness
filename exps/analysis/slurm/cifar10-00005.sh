...
#SBATCH --job-name=cifar10-00005
#SBATCH --output=out/cifar10-00005.out
...
--model_dir=/om/user/larend/models/robust/cifar10/00005 \
--disable_batch_norm \
--scale_factor=0.25 \
--dataset=cifar10 \
--pickle_dir=/om/user/larend/pickles/cifar10/00005 \
--host_filesystem=/om \
--rush
