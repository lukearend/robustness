...
#SBATCH --job-name=cifar10-00003
#SBATCH --output=out/cifar10-00003.out
...
--model_dir=/om/user/larend/models/robust/cifar10/00003 \
--scale_factor=2 \
--dataset=cifar10 \
--pickle_dir=/om/user/larend/pickles/cifar10/00003 \
--host_filesystem=/om
